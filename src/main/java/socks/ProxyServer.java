...
public class ProxyServer implements Runnable {
	...
	private void onConnect(ProxyMessage msg) throws IOException {
		...
		try {
			...
			log("Failed connecting to remote socket. Exception: "
	...
	private void onBind(ProxyMessage msg) throws IOException {
		...
		if (msg.version == 5)
			response = new Socks5Message(CProxy.SOCKS_SUCCESS, ss
	...
	private void onUDP(ProxyMessage msg) throws IOException {
		...
		response = new Socks5Message(CProxy.SOCKS_SUCCESS, relayServer.relayIP,
	...
	private void doAccept() throws IOException {
		...
		if (msg.version == 5)
			response = new Socks5Message(CProxy.SOCKS_SUCCESS, s
